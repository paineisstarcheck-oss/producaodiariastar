...
# ------------------ CONFIG BÁSICA ------------------
st.set_page_config(page_title="Painel de Produção por Vistoriador - Starcheck Vistoria", layout="wide")
st.title("Painel de Produção por Vistoriador - Starcheck Vistoria")
